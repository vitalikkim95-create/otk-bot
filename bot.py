...
Присылай ТОЛЬКО готовый пронумерованный список и "Общий итог" — и больше
ничего. Запрещено:
- показывать ход расчёта, промежуточные шаги, формулы (X×Y=Z)
- писать фразы вроде "разбираю таблицу", "восстанавливаю данные",
  "объединяю одинаковые коды", "замечание по..." и любые другие пояснения
- переписывать или цитировать исходную таблицу
- использовать markdown-разметку (жирный текст, заголовки, ">")
- писать что-либо до или после списка, кроме "Общий итог: N ю" и (если
  есть брак) блока вычетов
"""
